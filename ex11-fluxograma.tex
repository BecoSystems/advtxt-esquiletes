...
\begin{tikzpicture}
    ...
    \node (Menu) [process, below of=Inicio] {Exibir Menu};

    \node (insira) [process, below of=Menu] {Digitar nome do jogador };

    \node (texto1) [print, below of=insira] {Texto Introdução};

    \node (objeto) [input, below of=texto1] {objeto};
